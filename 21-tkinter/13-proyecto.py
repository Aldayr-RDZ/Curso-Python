...
def add():
    ...
    add_description_label.grid(row=3, column=0, padx=4, pady=4, sticky=NE)
...
products_box.heading("#0", text='Productos', anchor=W)
...
data_label = Label(ventana, text="Creado por Aldayr RDZ - 2022")
